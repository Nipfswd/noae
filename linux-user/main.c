...
void usage(void)
{
    printf("noae version 0.1, Copyright (c) 2003 Noah Juopperi\n"
           "usage: noae program [arguments...]\n"
           "Linux x86 emulator\n"
           );
    exit(1);
}
...
int main(int argc, char **argv)
{
    ...
    for(;;) {
        ...
        default:
        trap_error:
            fprintf(stderr, "NOAE: Unknown error %d, aborting\n", err);
